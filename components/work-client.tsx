        ...
        <div className="container mx-auto">
          <div className="flex flex-col xl:flex-row gap-x-8">
            ...
            <div className="text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0">
              ...
              >
                Explore my current portfolio to discover a showcase of my
                diverse and impactful work. From innovative designs to robust
                code implementations, each project reflects my commitment to
